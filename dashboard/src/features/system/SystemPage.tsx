        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="p-6 rounded-lg border border-kumo-hairline bg-kumo-canvas shadow-xs space-y-4">
            <div className="flex items-center gap-2.5 pb-3 border-b border-kumo-hairline">
              <div className="w-8 h-8 rounded-lg border border-kumo-hairline bg-kumo-recessed/60 text-[#F6821F] flex items-center justify-center">
                <Cpu size={18} />
              </div>
            ...
            <dl className="space-y-3 text-xs">
              ...
              <div className="flex justify-between items-center py-1 border-b border-kumo-hairline/40">
                ...
                <dd className="font-mono font-bold text-[#F6821F]">
              ...
              <div className="pt-1">
                ...
                <dd className="font-mono text-[11px] p-3 rounded-md border border-kumo-hairline bg-kumo-recessed/40 text-kumo-default leading-relaxed">
          ...
          <div className="p-6 rounded-lg border border-kumo-hairline bg-kumo-canvas shadow-xs space-y-4">
            <div className="flex items-center gap-2.5 pb-3 border-b border-kumo-hairline">
              <div className="w-8 h-8 rounded-lg border border-kumo-hairline bg-kumo-recessed/60 text-sky-500 flex items-center justify-center">
                <HardDrives size={18} />
              </div>
              <h3 className="font-semibold text-xs uppercase tracking-wider text-kumo-strong">
            ...
            <dl className="space-y-3 text-xs">
              ...
              <div className="flex justify-between items-center py-1 border-b border-kumo-hairline/40">
                <dt className="text-kumo-subtle font-medium">Ingress Source Mode</dt>
                <dd className="font-mono text-kumo-default">{sys?.source_mode ?? 'LIVE'}</dd>
              </div>
              <div className="flex justify-between items-center py-1 border-b border-kumo-hairline/40">
                <dt className="text-kumo-subtle font-medium">Raw Evidence SQLite Engine</dt>
