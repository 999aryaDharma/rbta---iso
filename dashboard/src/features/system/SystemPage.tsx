      ...
      <div className="px-6 py-4 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="p-4 rounded-lg border border-kumo-hairline bg-kumo-base">
            <div className="flex items-center gap-2.5 mb-3 pb-2.5 border-b border-kumo-hairline">
              <Cpu size={16} className="text-kumo-brand" />
          ...
          <div className="p-4 rounded-lg border border-kumo-hairline bg-kumo-base">
            <div className="flex items-center gap-2.5 mb-3 pb-2.5 border-b border-kumo-hairline">
              <HardDrives size={16} className="text-kumo-info" />
              <h3 className="font-semibold text-xs uppercase tracking-wider text-kumo-default">
